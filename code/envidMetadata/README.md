...
> - Envid metadata service (multimodal) (port 5016): `code/envidMetadataGCP/` (with `.env.multimodal.local` overlay)
>
> See: `code/envidMetadataGCP/README.md`.
...
This README is retained for historical reference. The current local-first/GCS-first implementation lives under `code/envidMetadataGCP/`.
