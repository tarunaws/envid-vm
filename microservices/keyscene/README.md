...
- Ensures TransNetV2 weights are present under `microservices/keyscene/weights/transnetv2-weights/`
...
- `microservices/keyscene/weights/transnetv2-weights/` (directory must contain `saved_model.pb` and `variables/`)
